  ...
  return (
    <div className="landing-container relative flex justify-center mt-20 pt-10">
      <div className="relative w-[95%]">
        ...
        <div className="absolute top-0 left-0 w-10 h-10  md:w-12 md:h-12 lg:w-20 lg:h-20 border-t-4 border-l-4 border-[#D1A83A]"></div>
        <div className="absolute top-0 right-0 w-10 h-10  md:w-12 md:h-12 lg:w-20 lg:h-20 border-t-4 border-r-4 border-[#D1A83A]"></div>
        <div className="absolute bottom-0 left-0 w-10 h-10  md:w-12 md:h-12 lg:w-20 lg:h-20 border-b-4 border-l-4 border-[#D1A83A]"></div>
        <div className="absolute bottom-0 right-0 w-10 h-10  md:w-12 md:h-12 lg:w-20 lg:h-20 border-b-4 border-r-4 border-[#D1A83A]"></div>
      </div>
    </div>
  );
};
